...
export type WecodeBashParams = Static<typeof bashSchema>;

export interface WecodeBashOptions {
  cwd: string;
  sessionId?: number;
  jobs?: BashJobHost;
  shellPath?: string;
...
function requireJobs(options: WecodeBashOptions): { sessionId: number; jobs: BashJobHost } {
...
async function runForeground(
  options: WecodeBashOptions,
  params: WecodeBashParams,
  signal?: AbortSignal,
...
export function createWecodeBashTool(
  options: WecodeBashOptions,
