const AGENT_COLORS = ['bg-blue-500', 'bg-indigo-500', 'bg-teal-500', 'bg-violet-500', 'bg-amber-600']
const PROVIDER_COLORS = ['bg-sky-600', 'bg-emerald-600', 'bg-orange-500', 'bg-rose-500', 'bg-violet-600']
