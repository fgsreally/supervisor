import { appendContpluginFilesToSystemPrompt } from "../../../core/resource/context-files.js";
...
export function createShadowResultSchema(
  pluginProperties: Record<string, TSchema> = {},
): TSchema {
  return Type.Union([
...
export function getShadowSystemPrompt(cwd?: string, appendedPrompt?: string): string {
  ...
  const withContext = cwd ? appendContpluginFilesToSystemPrompt(prompt, cwd) : prompt;
