import type { PluginEvent } from "../../plugin/index.js";
import type { SessionPluginHost } from "../../plugin/runtime/index.js";
import { minimizeOutput } from "./minimizer.js";

export function attachOutputMinimizerHook(plugin: SessionPluginHost): void {
  plugin.on("tool.after_call", (event: Extract<PluginEvent, { type: "tool.after_call" }>) => {
    ...
    const details = event.result.details as { engine?: string; minimized?: string } | undefined;
