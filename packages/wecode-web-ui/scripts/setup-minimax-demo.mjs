 ...
 *
 * Skill lives under agent home (~/.pi/wecode/agents/{id}/skills/), NOT workspace.
 */
...
const AGENT_HOME = join(homedir(), ".pi", "wecode", "agents", AGENT_ID);
...
async function cleanup() {
  ...
  for (const dir of ["workspace-demo", "readme-writer", "neko-doc-writer"]) {
    try {
      rmSync(`${WORKSPACE}/.pi/wecode/skills/${dir}`, { recursive: true, force: true });
    } catch {
      // ignore
    }
  }
