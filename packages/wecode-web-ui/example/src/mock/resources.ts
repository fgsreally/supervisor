export type ResourceKind = "skills" | "plugins" | "prompts";
...
export const mockGlobalResources: MockResourceItem[] = [
  // Global resources now use wecode paths only, not coding-agent's ~/.pi/agent/
  // Skills/plugins/prompts are loaded from ~/.pi/wecode/ or cwd/.pi/wecode/
];
  ...
  "frontend-dev": [
    {
      ...
      rootPath: "~/.pi/wecode/agents/frontend-dev/skills/vue3-composition",
      files: [
        {
          id: "a-fe-vue3-skill",
          fileName: "SKILL.md",
...
`,
    ...
    },
    {
      ...
      fileName: "index.ts",
      path: "~/.pi/wecode/agents/frontend-dev/plugins/vue-helper/index.ts",
  ...
  "css-specialist": [
    {
      ...
      rootPath: "~/.pi/wecode/agents/css-specialist/skills/tailwind-patterns",
      files: [
        {
  ...
  "test-runner": [
    {
      ...
      rootPath: "~/.pi/wecode/agents/test-runner/skills/vitest-fix",
      files: [
        {
