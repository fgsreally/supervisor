...
const mdHighlightLight = HighlightStyle.define([
	...
	{ tag: t.monospace, color: '#953800', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace' },
...
const mdHighlightDark = HighlightStyle.define([
	...
	{ tag: t.monospace, color: '#ce9178', fontFamily: 'ui-monospace, SFMono-Regular, Menlo, Consolas, monospace' },
