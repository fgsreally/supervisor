...
export const mockAgents: MockAgent[] = [
  {
    ...
    toolsPreset: "coding",
    homeDir: "~/.pi/wecode/agents/frontend-dev",
    systemMd:
      "你是一名专注于现代前端开发的工程师。使用 Vue 3 Composition API 和 TypeScript。\n\n优先复用现有组件，保持与 wecode-web-ui example 的微信风格一致。",
    category: "frontend",
  },
  {
    id: "css-specialist",
    ...
    modelId: "claude-sonnet-4-6",
    toolsPreset: "coding",
    homeDir: "~/.pi/wecode/agents/css-specialist",
  ...
  },
  {
    ...
    modelId: "gpt-4o",
    toolsPreset: "coding",
    homeDir: "~/.pi/wecode/agents/api-integrator",
  ...
  },
  {
    ...
    toolsPreset: "coding",
    homeDir: "~/.pi/wecode/agents/test-runner",
  ...
  },
  {
    ...
    modelId: "claude-sonnet-4-6",
    toolsPreset: "coding",
    homeDir: "~/.pi/wecode/agents/backend-architect",
  ...
  },
  {
    ...
    homeDir: "~/.pi/wecode/agents/general-assistant",
