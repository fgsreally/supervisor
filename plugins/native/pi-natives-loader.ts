 ...
 *
 * Wecode runs on **Node**, not Bun. The official `@oh-my-pi/pi-natives`
...
export function loadPiNativesBindings(): PiNativesBindings {
  ...
  try {
    ...
    throw new Error(
      `native: missing platform package ${pkgName}. Reinstall this plugin so npm can fetch the native binary for your machine.`,
    );
  }
