<template>
  <div class="flex-1 flex min-w-0 basis-0 h-full w-full items-center justify-center overflow-hidden" style="background: var(--app-settings-bg)">
    <div class="text-center px-8">
      <div class="w-24 h-24 mx-auto rounded-full flex items-center justify-center mb-4" style="background: var(--app-list-search-bg)">
...
const title = computed(() => {
  switch (props.tab) {
    case 'contacts': return '选择一个智能代理'
    case 'providers': return '选择一个模型服务'
    case 'resources': return '选择资源'
    default: return 'Pi Supervisor'
  }
})
