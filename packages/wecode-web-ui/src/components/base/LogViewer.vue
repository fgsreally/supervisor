...
const { t } = useI18n();
const SHOW_TIME_KEY = "wecode:session-log-show-time";
const SHOW_DELTA_KEY = "wecode:session-log-show-delta";
...
const TAG_COLORS: Record<string, string> = { plugin: "#6366f1", system: "#0ea5e9", git: "#22c55e", worktree: "#84cc16", runtime: "#f97316", approval: "#eab308", timing: "#64748b" };
