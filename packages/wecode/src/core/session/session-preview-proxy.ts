...
const HIDDEN_SCROLLBAR_STYLE =
  '<style id="wecode-preview-scrollbars">*{scrollbar-width:none}*::-webkit-scrollbar{display:none}</style>';
...
export function rewriteSessionPreviewText(
  ...
  // Keep both on the Session preview route instead of falling back to Wecode's root.
