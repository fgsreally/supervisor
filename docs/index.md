...
features:
  - title: WeCode
    details: 多会话管理、持久化 Job、HTTP API、插件框架、MCP、滚动压缩
    link: /wecode/overview
  - title: Web UI
    details: Vue 3 控制台：对话中断、Job、Slash、Agent/Provider/资源管理
    link: /web-ui/overview
  - title: 子代理与 Shadow
    details: spawn_agent + Session 委派白名单；Shadow 旁路观察主会话
    link: /wecode/subagents
  - title: 插件与外部 Agent
    details: 全局 catalog + bind；Codex / Claude / Kimi / Cursor / MiMo / ACP；仓库插件 strict-sdd 等
    link: /wecode/plugins
---
