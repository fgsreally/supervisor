...
import { getAgentHomeDir, readAgentHomeSystemPrompt } from "../agent/index.js";
import { ContextAgent, ContextDb, ContextSession } from "../core/session-extension/index.js";
...
import { ToolPolicy } from "../core/session-extension/index.js";
...
function readExtensionDirectory(
  rootDir: string,
  entryPath: string,
  isFlatFile: boolean,
): ExtensionFileInfo[] {
...
const SYSTEM_TOOLS: Array<Pick<AgentToolInfo, "name" | "source" | "description">> = [
  {
    ...
    source: "system",
    description: "Enqueue a message for the parent session (shadow child only)",
  },
  {
    name: "list_supervisor_resources",
    source: "system",
    description: "List readable pi-supervisor:// resources",
  },
  { name: "spawn_agent", source: "system", description: "Spawn a delegated subagent session" },
  {
    name: "read_supervisor_resource",
    source: "system",
    description: "Read pi-supervisor resource URLs",
  },
];
...
export async function resolveAgentTools(
  ...
  cwd: string,
  extensionRegistry?: {
    getMany(slugs: string[]): Array<{
      definition: import("../extension/types.js").ExtensionDefinition;
      error?: string;
    }>;
  },
