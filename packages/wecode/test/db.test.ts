...
beforeEach(() => {
  tmpDir = join(tmpdir(), `wecode-db-test-${Date.now()}`);
...
describe("wecode: WecodeDb", () => {
  ...
  it("persists project plugin metadata", () => {
  ...
  it("clears process-bound statuses after Wecode restart", () => {
