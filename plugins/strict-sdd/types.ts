import type { AgentPluginContext, PluginSession } from "wecode";
...
export interface StrictSddContext {
  ...
  agent: AgentPluginContext["agent"];
  project: PluginSession["project"];
  inject: PluginSession["inject"];
  exec: AgentPluginContext["exec"];
  log: AgentPluginContext["log"];
}
