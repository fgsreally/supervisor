import type { Agent, Model, Provider, Session } from "wecode";
...
/** Plugin resource item */
export interface PluginResourceItem extends ResourceItemBase {
  kind: "plugins";
  entryPath?: string;
  version?: string;
}
...
export type ResourceItem = SkillResourceItem | PluginResourceItem | PromptResourceItem;
