...
import type { WecodeSettings } from "../../utils/wecode-settings.js";
...
function readFcmServiceAccount(settings: WecodeSettings): FcmServiceAccount | null {
...
function readApnsKey(settings: WecodeSettings): string | null {
...
async function sendFcm(device: PushDeviceRow, payload: PushPayload, settings: WecodeSettings) {
...
async function sendApns(device: PushDeviceRow, payload: PushPayload, settings: WecodeSettings) {
...
export function isPushConfigured(settings: WecodeSettings): boolean {
  return Boolean(
