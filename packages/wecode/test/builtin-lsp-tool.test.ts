...
import { createOverrideLspTool } from "../src/tools/lsp/tool.js";

let tmpDir: string;

beforeEach(() => {
  tmpDir = join(tmpdir(), `wecode-lsp-${Date.now()}`);
...
describe("wecode: override-lsp-tool", () => {
