  ...
  try {
    ...
    for (let round = 1; round <= maxRounds; round++) {
      ...
      await runWatson({
        ...
        toolsPreset: "coding",
        prompt: [
          "The git worktree could not be removed while finalizing the Session; a local service or process may still be using it.",
          "Read AGENTS.md in the project root and in the worktree first, especially the Local Development Services instructions.",
