...
import type { ExtensionContext } from "../../extension/index.js";
...
import { parseSupervisorResourceUrl, type ParsedSupervisorResourceUrl } from "./url.js";
...
async function readAgentResource(
  ...
  const { readAgentHomeSystemPrompt } = await import("../../agent/index.js");
