...
const todoPlugin: PluginDefinition = {
...
async function applyToolStage(ctx: PluginContext, stage: string | null): Promise<void> {
...
async function currentTask(ctx: PluginContext, kind: "goal" | "plan") {
...
async function findCurrentTaskPath(ctx: PluginContext, kind: "goal" | "plan") {
