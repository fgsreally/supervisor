...
export interface UISession {
  ...
  stage?: string | null;
  /** Plugin data only; core fields (title/avatar/pinned/...) live on the session itself. */
  meta: {
    description?: string;
    /** Native Agent IDs authorized for the subagent plugin in this session. */
    subagentIds?: number[];
    [key: string]: unknown;
  };
...
export type UIResourceKind = "skills" | "plugins" | "prompts" | "mcp";
