...
import { askResultSummary, isAskToolName, parseAskQuestions, parseAskResultFromToolResult } from "./ask-tool";
...
export function toolResultSummary(name: string, content: Array<{ type: string; text: string }> | undefined): string {
...
export function toolResultDetail(content: Array<{ type: string; text: string }> | undefined): string {
