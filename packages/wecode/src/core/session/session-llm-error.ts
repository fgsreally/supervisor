...
export function extractAgentEndLlmError(event: AgentHarnessEvent): AssistantMessage | undefined {
...
export function assistantHasVisibleContent(message: { content?: unknown }): boolean {
