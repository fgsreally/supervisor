import type { PluginDefinition, PluginSqliteDatabase } from "../../types.js";
import { McpClientManager } from "./client.js";
import { loadMcpConfigFile } from "./config.js";
import type { McpServerConfigType } from "./types.js";

function listBoundMcpConfigPaths(sqlite: PluginSqliteDatabase, agentId: number): string[] {
  const rows = sqlite
    .prepare(
...
const mcpPlugin: PluginDefinition = {
  name: "mcp",
  async setup(ctx) {
