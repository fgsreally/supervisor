...
import AgentSystemPromptPanel from "../../components/agent/AgentSystemPromptPanel.vue";
import AgentResourceBrowser from "../../components/agent/AgentResourceBrowser.vue";
import AgentPluginsPanel from "../../components/agent/AgentPluginsPanel.vue";
...
import AgentEditDialog from "../../components/agent/AgentEditDialog.vue";
import ExternalAgentDetails from "../../components/external-agent/ExternalAgentDetails.vue";
...
const rightTabs = computed(() => {
  if (isExternal.value) {
    return [
      ...
      { id: "plugins" as AgentTab, label: t("agent.plugins") },
    ];
  }
  const tabs: Array<{ id: AgentTab; label: string }> = [
    ...
    { id: "plugins", label: t("agent.plugins") },
