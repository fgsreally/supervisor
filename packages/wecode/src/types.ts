...
/** Runtime shape of SQLiteSessionStorage.getMetadata() in wecode. */
export interface WecodeHarnessMetadata extends SessionMetadata {
...
export interface Session {
  ...
  createdAt: Date;
  lastActiveAt: Date;
  /** Plugin data only. Core UI fields live in columns. */
  meta: Record<string, unknown>;
...
export interface Agent {
  ...
  /** Plugin-owned data only; core agent fields live in columns. */
  meta: Record<string, unknown>;
  createdAt: Date;
  updatedAt: Date;
}
...
/** API / storage view: pi session entry + wecode columns. */
