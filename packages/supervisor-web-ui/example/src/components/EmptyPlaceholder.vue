<template>
  <div class="flex-1 flex min-w-0 basis-0 h-full w-full items-center justify-center bg-[#f5f5f5] overflow-hidden">
    <div class="text-center px-8">
      <div class="w-24 h-24 mx-auto bg-[#e6e6e6] rounded-full flex items-center justify-center mb-4">
...
const title = computed(() => {
  switch (props.tab) {
    case 'contacts': return '选择一个 Agent'
    case 'providers': return '选择一个 Provider'
