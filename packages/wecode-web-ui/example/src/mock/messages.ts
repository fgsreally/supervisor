...
const session12Messages: MockEntry[] = [
  {
    ...
    message: {
      role: "user",
      content: "生成调用 wecode /sessions 的 API 客户端草稿。",
    },
  },
  {
    id: "s12-2",
  ...
  },
  {
    ...
    toolName: "write",
    content: [{ type: "text", text: "Wrote src/api/wecode-client.ts" }],
  },
  {
    id: "s12-4",
    type: "message",
    message: {
      ...
      content: [
        { type: "text", text: "**read** 确认写入内容。" },
        {
          ...
          id: "call_read_api",
          name: "read",
          arguments: { path: "src/api/wecode-client.ts" },
        },
      ],
    },
  },
...
const session2Messages: MockEntry[] = [
  {
    ...
    message: {
      role: "user",
      content: "检查 wecode 数据库 schema 并跑迁移",
    },
  },
  {
    id: "s2-2",
    ...
    message: {
      role: "assistant",
      content: [
        { type: "text", text: "**read** `packages/wecode/src/db.ts` 查看表结构。" },
        {
          type: "toolCall",
          id: "call_read_db",
          name: "read",
          arguments: { path: "packages/wecode/src/db.ts", offset: 1, limit: 80 },
        },
      ],
    },
  },
  {
    ...
    toolName: "read",
    content: [{ type: "text", text: "// WecodeDb — sessions, agents, parent_id, cwd...\n" }],
  },
  {
    id: "s2-4",
    type: "message",
    message: {
      ...
      content: [
        { type: "text", text: "用 **bash** 执行测试（迁移脚本）。" },
        {
          ...
          name: "bash",
          arguments: {
            intent: "运行 wecode 包的 session-manager 测试",
            command: "npm test -w wecode -- session-manager",
          },
        },
      ],
    },
...
const session3Messages: MockEntry[] = [
  {
    id: "s3-1",
    type: "message",
    message: { role: "user", content: "wecode 和 pi agent 有什么区别？" },
  },
  {
    id: "s3-2",
    type: "message",
    message: {
      ...
      content: [
        {
          type: "text",
          text: "Wecode 管理多个嵌入式 Agent 会话（含 parentId 子代理）；单个 pi agent 是一次对话与工具循环。Wecode 默认工具集与 pi 相同：**read / write / edit / bash**。",
        },
      ],
    },
  },
...
const session121Messages: MockEntry[] = [
  {
    ...
    message: {
      role: "user",
      content: "对 wecode-client.ts 跑一遍测试。",
    },
  },
  {
    id: "s121-2",
