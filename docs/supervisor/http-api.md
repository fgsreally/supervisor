...
| GET    | `/agents/:id/system-md`              | 读取 `system_prompt`（兼容路径名） |
| PUT    | `/agents/:id/system-md`              | 写入 `system_prompt`               |
...
| POST   | `/sessions/:id/read`                          | 消息标已读并清 `sessions.unread`           |
...
| GET    | `/sessions/:id/messages/:entryId`             | 单条完整消息                               |
| DELETE | `/sessions/:id/queued-inputs/:inputId`        | 删除排队输入                               |
| POST   | `/sessions/:id/queued-inputs/:inputId/submit` | 立即提交排队输入                           |
...
## Session — 子 Agent / 阶段 / 任务

| Method | Path                       | 说明                               |
| ------ | -------------------------- | ---------------------------------- |
| PUT    | `/sessions/:id/subagents`  | 更新 `meta.subagentIds` 委派白名单 |
| GET    | `/sessions/:id/workflow`   | 读取 stage 兼容视图                |
| PATCH  | `/sessions/:id/workflow`   | 更新 stage；status 不持久化        |
...
| GET    | `/sessions/:id/files`                                        | Session 专属文件列表 |
| GET    | `/sessions/:id/files/content`                                | Session 专属文件内容 |
| POST   | `/sessions/:id/media`                                        | 上传 Session media   |
| GET    | `/sessions/:id/media/:mediaId`                               | 读取 Session media   |
