  ...
  >
    ...
    <div class="flex flex-1 overflow-hidden">
      ...
      <div class="w-1/2 border-r" style="border-color: var(--app-border-subtle)">
        <div
          class="flex items-center px-4 py-2 shrink-0 border-b"
          style="background: var(--app-list-header-bg); border-color: var(--app-border-subtle)"
        >
          <h2 class="text-[13px] font-medium flex-1" style="color: var(--app-text-secondary)">
            供应商
          </h2>
      ...
      <div class="w-1/2">
        ...
        <div class="flex-1 overflow-y-auto custom-scrollbar">
          ...
          <button
            ...
            @click="
              $emit('select-model', { providerId: selectedProviderId, modelId: model.modelId })
            "
          ...
          >
            ...
            <div class="flex-1 min-w-0">
              <div class="flex items-center gap-2">
                <div class="text-[11px] truncate" style="color: var(--app-text-secondary)">
              ...
              <div class="text-[11px] truncate font-mono" style="color: var(--app-text-secondary)">
                {{ model.modelId }}
              </div>
            </div>
          </button>
    ...
    <div
      ...
      :style="{
        left: `${providerContextMenuPosition.x}px`,
        top: `${providerContextMenuPosition.y}px`,
      }"
